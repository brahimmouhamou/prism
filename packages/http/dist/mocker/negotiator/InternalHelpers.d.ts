...
export declare function findFirstExample(
  httpContent: IHttpContent
): O.Option<import('@stoplight/types').INodeExample | import('@stoplight/types').INodeExternalExample>;
export declare function findExampleByKey(
  httpContent: IHttpContent,
  exampleKey: string
): O.Option<import('@stoplight/types').INodeExample | import('@stoplight/types').INodeExternalExample>;
export declare function findBestHttpContentByMediaType(
...
export declare function findResponseByStatusCode(
  responses: IHttpOperationResponse[],
  statusCode: number
): O.Option<IHttpOperationResponse>;
export declare function createResponseFromDefault(
  responses: IHttpOperationResponse[],
  statusCode: number
): O.Option<IHttpOperationResponse>;
