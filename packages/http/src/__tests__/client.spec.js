    ...
    describe('with mocking set to true', () => {
        describe('get a resource', () => {
            ...
            beforeAll(() => {
                ...
                client = (0, client_1.createClientFromOperations)([
                    {
                        id: 'operation',
                        method: 'get',
                        path: '/pet',
            ...
            describe('when calling with no options', () => {
                ...
                test('shall call the mocker with the default options', () => expect(mock.default).toHaveBeenCalledWith({
                    input: expect.anything(),
                    resource: expect.anything(),
                    config: config.mock,
                }));
                test('shall ultimately call the main request method with the current HTTP Method', () => expect(client.request).toHaveBeenCalledWith('/pet', { method: 'get' }, undefined));
            });
