...
function generate(bundle, source) {
    return (0, function_1.pipe)((0, filterRequiredProperties_1.stripWriteOnlyProperties)(source), E.fromOption(() => Error('Cannot strip writeOnly properties')), E.chain(updatedSource => (0, Either_1.tryCatch)(() => sortSchemaAlphabetically(jsf.generate({ ...(0, lodash_1.cloneDeep)(updatedSource), __bundled__: bundle })), Either_1.toError)));
}
...
function generateStatic(resource, source) {
    return (0, Either_1.tryCatch)(() => sampler.sample(source, {}, resource), Either_1.toError);
}
