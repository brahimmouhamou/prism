...
const helpers = {
    ...
    negotiateOptionsBySpecificResponse(requestMethod, desiredOptions, response) {
        ...
        return logger => {
            ...
            }, mediaTypes => (0, function_1.pipe)(O.fromNullable(response.contents), O.chain(contents => (0, InternalHelpers_1.findBestHttpContentByMediaType)(contents, mediaTypes)), O.fold(() => (0, function_1.pipe)(createEmptyResponse(response.code, headers, mediaTypes), O.map(payloadlessResponse => {
    ...
    negotiateOptionsForUnspecifiedCode(httpOperation, desiredOptions) {
        return (0, function_1.pipe)((0, InternalHelpers_1.findLowest2xx)(httpOperation.responses), O.alt(() => (0, InternalHelpers_1.findFirstResponse)(httpOperation.responses)), RE.fromOption(() => types_1.ProblemJsonError.fromTemplate(errors_1.NO_RESPONSE_DEFINED)), RE.chain(response => helpers.negotiateOptionsBySpecificResponse(httpOperation.method, desiredOptions, response)));
    },
    negotiateOptionsBySpecificCode(httpOperation, desiredOptions, code) {
        return (0, function_1.pipe)((0, withLogger_1.default)(logger => (0, function_1.pipe)((0, InternalHelpers_1.findResponseByStatusCode)(httpOperation.responses, code), O.alt(() => {
            ...
            return (0, InternalHelpers_1.createResponseFromDefault)(httpOperation.responses, code);
    ...
    findResponse(httpResponses, statusCodes) {
        ...
        return logger => (0, function_1.pipe)(others.reduce((previous, current, index) => (0, function_1.pipe)(previous, O.alt(() => {
            ...
            return (0, function_1.pipe)((0, InternalHelpers_1.createResponseFromDefault)(httpResponses, first), O.fold(() => {
